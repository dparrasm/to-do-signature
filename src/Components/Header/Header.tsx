                        ...
                        <Toolbar className={classes.toolBar}>
                            ...
                            <ul className={classes.iconBar}>
                                <li className={classes.iconBarElement}>
                                    <Link to="/create" onClick={() => this.props.pickForm("/create")}>
                                        <Button icon={icons.create} text="Create" />
                                    </Link>
                                </li>
                                <li className={classes.iconBarElement} onClick={() => this.props.pickForm("/send")}>
                                    <Link to="/send">
                                        <Button icon={icons.send} text="Send" />
                                    </Link>
                                </li>
                                <li className={classes.iconBarElement} onClick={() => this.props.pickForm("/received")}>
                                    <Link to="/received">
                                        <Button icon={icons.received} text="Received" />
                                    </Link>
                                </li>
                                <li className={classes.iconBarElement} onClick={() => this.props.pickForm("/contacts")} >
                                    <Link to="/contacts">
