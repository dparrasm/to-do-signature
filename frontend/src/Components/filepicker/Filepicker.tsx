...
export default function Filepicker(props) {
  ...
  useEffect(() => {
    ...
    // Define una función auxiliar para realizar las actualizaciones del estado
    ...
    // Llama a la función auxiliar para realizar las actualizaciones del estado
    performStateUpdates()
  ...
  return (
    <>
      {title !== undefined ? (
        title !== 'ADD FROM LIST' ? (
          <button className="filepicker-button" onClick={openFileSelector}>
            {title}
          </button>
        ) : (
