...
export const updatedDocument = (title) => {
  return {
    subject: 'Document Updated',
    message: 'Dear valued user,\n'
      .concat(
        `\nWe wanted to inform you that your document ${title} has been recently updated.`
      )
      .concat('\n To view the updated document, please visit our platform.')
      .concat(
        '\n\nIf you have any questions or need assistance, our support team is available to assist you.'
      )
      .concat('\nassistance.')
